def game():
    ...
    def door():
        ...
        time.sleep(1)
        print("You are about to knock when the door opens and out steps a " + enemy + " .")
        time.sleep(1)
    ...
    def victory():
        print(" ")
        print("As the " + enemy + " moves to attack, you unsheath your new sword.")
        time.sleep(1)
        print("The Sword of Ogoroth shines brightly in your hand as you brace yourself for the attack.")
        time.sleep(1)
        print("But the " + enemy + " takes one look at your shiny new toy and runs away!")
        time.sleep(1)
        print("You have rid the town of the " + enemy + " . You are victorious!")
    def fightchoice():
        print(" ")
